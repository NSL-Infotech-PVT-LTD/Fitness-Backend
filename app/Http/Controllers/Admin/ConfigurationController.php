...
class ConfigurationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            $configuration = Configuration::where('about_us', 'LIKE', "%$keyword%")
                ->orWhere('terms_and_conditions_organiser', 'LIKE', "%$keyword%")
                ->orWhere('terms_and_conditions_coach', 'LIKE', "%$keyword%")
                ->orWhere('terms_and_conditions_athlete', 'LIKE', "%$keyword%")
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
			'about_us' => 'required',
			'terms_and_conditions_organiser' => 'required',
			'terms_and_conditions_coach' => 'required',
			'terms_and_conditions_athlete' => 'required'
		]);
