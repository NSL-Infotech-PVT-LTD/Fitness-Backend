...
class RegisterController extends ApiController {
    ...
    public function frelancerUpdate(Request $request) {
        ...
        $rules = ['firstname' => 'required', 'phone' => '', 'email' => 'required|email|unique:users,email,' . \Auth::id(), 'profile_pic' => 'required', 'bio' => 'required', 'category_id' => 'required', 'experience' => 'required', 'hourly_rate' => 'required', 'latitude' => '', 'longitude' => '', 'portfolio_image_1' => 'required', 'portfolio_image_2' => '', 'portfolio_image_3' => '', 'portfolio_image_4' => ''];
        $validateAttributes = parent::validateAttributes($request, 'POST', array_merge($this->requiredParams, $rules), array_keys($rules), false);
        if ($validateAttributes):
            return $validateAttributes;
        endif;
