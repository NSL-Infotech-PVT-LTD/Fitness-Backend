...
<!--                    <a href="{{ url('/admin/users/' . $user->id . '/edit') }}" title="Edit User"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php foreach (['id', 'name', 'email', 'phone', 'location', 'business_hour_starts', 'business_hour_ends', 'bio', 'expertise_years', 'hourly_rate', 'profession', 'experience_detail', 'training_service_detail','created_at'] as $column): ?>
                                    <tr>
                                ...
                                <tr>
                                    <th>Profile Image.</th>
                                    <td><img width="150" src="{{url('uploads/coach/profile_image/'.$user->profile_image)}}"></td>
                                </tr>
                                <tr>
                                    <th>Police Doc.</th>
