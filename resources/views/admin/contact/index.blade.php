                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Message</th><th>Media</th><th>Created By</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($contact as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->message }}</td><td>{{ $item->media }}</td><td>{{ $item->created_by }}</td>
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/contact/' . $item->id . '/edit') }}" title="Edit Contact"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                            {!! Form::open([
                                                'method' => 'DELETE',
