...
<?php foreach ($rules as $rule): ?>
    ...
    <?php elseif ($rule == 'target_id'): ?>
                        {data: 'target_id', name: 'target_id', orderable: false, searchable: false},
    <?php elseif ($rule == 'user_id'): ?>
                        {data: 'user_id', name: 'user_id', orderable: false, searchable: false},
    <?php elseif ($rule == 'owner_id'): ?>
                        {data: 'owner_id', name: 'owner_id', orderable: false, searchable: false},
    <?php else: ?>
                        {data: "{{$rule}}", name: "{{$rule}}"},
    <?php endif; ?>
<?php endforeach; ?>
