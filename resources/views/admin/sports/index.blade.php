    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/admin/sports/create') }}" class="btn btn-success btn-sm" title="Add New Sport">
            ...
            if (result.value) {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == 'Success') {
                            swal.fire("Deleted!", "Sport has been deleted", "success");
